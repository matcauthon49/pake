...
\begin{enumerate}
	\item The verification key $\VK$ is used more than once by the system. This encompasses the case when the client's generation algorithm outputs $\VK$ twice for two separate instantiations in two separation sessions.
